...
class __TwigTemplate_84f93a51bd0f37cdb9877ef0baca9e3e extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["field"] ?? null), "customOptions", [], "any", false, false, false, 4), "get", [0 => "showFlag"], "method", false, false, false, 4)) {
            ...
            if ( !(null === twig_get_attribute($this->env, $this->source, ($context["field"] ?? null), "customOption", [0 => "flagCode"], "method", false, false, false, 5))) {
                ...
                echo "\" src=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl((("bundles/easyadmin/images/flags/" . twig_get_attribute($this->env, $this->source, ($context["field"] ?? null), "customOption", [0 => "flagCode"], "method", false, false, false, 6)) . ".svg")), "html", null, true);
                echo "\">
    ";
            }
        }
...
";
    ...
    {
        return new Source("", "@EasyAdmin/crud/field/country.html.twig", "C:\\wamp64\\www\\comperis\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\field\\country.html.twig");
    }
}
